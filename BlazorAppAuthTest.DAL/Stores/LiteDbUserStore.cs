...
namespace BlazorAppAuthTest.CustomAuntAuth
{
    ...
    /// </summary>
    public partial class LiteDbUserStore : IUserPasswordStore<IdentityUser> // needed to use passwords
    {
    ...
    /// IUserPasswordStore<IdentityUser>
    /// </summary>
    public partial class LiteDbUserStore : IUserEmailStore<IdentityUser> // needed to build auntefication on emails
    {
